...
<div id = "side-box" class="noSelection">
	...
	<div id = "page" draggable="false"> 
		...
		<div id = "pgps" class="pagesCd"><div><img width="10" class="pageimg" src = "resources/tag/pluss.png"><div style="margin-left: 8px;">페이지 추가</div></div></div>
		<div id = "trash" class="pagesCd"><div><img width="20" class="pageimg" src = "resources/tag/trash.png"><div style="margin-left: 2px;">휴지통</div></div></div>
	</div>
</div> 
<!-- popup -->
